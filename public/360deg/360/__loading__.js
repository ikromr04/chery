...
pc.script.createLoadingScreen(function (app) {
    ...
    app.on('preload:start', function() {
        ...
        logoAsset = app.assets.find('T19 FL MY_Web GL_0001.jpg');
        var demo = setInterval(function(){
            logoAsset = app.assets.find('T19 FL MY_Web GL_00'+a.toString()+'.jpg');
        ...
        // var logoAsset = app.assets.find('logo_音乐可视化_0000.png');
