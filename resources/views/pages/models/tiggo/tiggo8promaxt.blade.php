...
@section('content')
  <div class="modelwrap tiggo8promax-T18FL3 sameModel">
    ...
    <section>
      <div class="banner">
        <div class="txt wow fadeInLeft animated"  data-wow-duration="1s" data-wow-delay=".8s">
          <img src="images/tiggo8ProMax/tiggo8promax_tit.png" class="">
        </div>
        <div class="mediabox">
          <!--<video src="video/video.mp4" poster="images/newtiggo8pro_banner.jpg" muted=""></video>-->
          <!--<span class="play"></span>-->
          <img src="images/tiggo8ProMax/tiggo8promax_banner.jpg" class="m_hide"/>
          <img src="images/tiggo8ProMax/tiggo8promax_banner_m.jpg" class="pc_hide"/>
        </div>
      </div>
      <!--Fashionable Design-->
      <div class="modelmenu">
        ...
        <div class="swiper-container sameSwiper samebox swiper-no-swiping">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_design_p1.jpg" class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_design_p1_m.jpg" class="pic pc_hide"/>
            </div>
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_design_p2.jpg"  class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_design_p2_m.jpg"  class="pic pc_hide"/>
            </div>
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_design_p3.jpg"  class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_design_p3_m.jpg"  class="pic pc_hide"/>
            </div>
          </div>
        </div>
        <div class="cutTab wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
          <div class="cutbtn on">High-end smart business SUV</div>
          <div class="cutbtn">R19 Sporty wheels</div>
          <div class="cutbtn">Diamond-shaped front grille + Luminous LOGO</div>
        </div>
      </div>
      <!--INTERIOR-->
      <div class="comfort module" id="module2">
        ...
        <div class="swiper-container sameSwiper samebox swiper-no-swiping">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_inner_p1.jpg" class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_inner_p1_m.jpg" class="pic pc_hide"/>
            </div>
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_inner_p2.jpg"  class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_inner_p2_m.jpg"  class="pic pc_hide"/>
            </div>
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_inner_p3.jpg"  class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_inner_p3_m.jpg"  class="pic pc_hide"/>
            </div>
          </div>
        </div>
        <div class="cutTab wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
          <div class="cutbtn on">Sony Sound <br />System (10 Speakers)</div>
          <div class="cutbtn">24.6 "large curved <br /> intelligent dual screen</div>
          <div class="cutbtn">The Queen's passenger and <br /> seat backs are ventilated</div>
        </div>
      </div>
      <!--Intelligent Tech-->
      <div class="tech module graybg" id="module3">
        ...
        <div class="swiper-container sameSwiper samebox">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_tech_p1.jpg" class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_tech_p1_m.jpg" class="pic pc_hide"/>
              <div class="textdet pc_hide">
                <p>540 ° HD panoramic image </p>
              </div>
            </div>
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_tech_p2.jpg" class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_tech_p2_m.jpg" class="pic pc_hide"/>
              <div class="textdet pc_hide">
                <p>Type-A + Type-C <br />50W Mobile phone fast charge</p>
              </div>
            </div>
          </div>
        ...
        <div class="cutwindow">
          <div class="cutbtn on">
            <div class="text">
              <h5>540 ° HD panoramic image </h5>
            </div>
          </div>
          <div class="cutbtn">
            <div class="text">
              <h5>Type-A + Type-C <br />50W Mobile phone fast charge</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="power module" id="module4">
        ...
        <div class="powerbox samebox">
          <div class="caritem">
            <div class="imgbox">
              <img src="images/tiggo8ProMax/tiggo8promax_power_p1.jpg"/>
            </div>
            <div class="textbox">
              <h5>2.0 TGDI KUNPENG POWER</h5>
            </div>
          </div>
          <div class="caritem">
            <div class="imgbox">
              <img src="images/tiggo8ProMax/tiggo8promax_power_p2.jpg"/>
            </div>
            <div class="textbox">
      ...
      <div class="safety module" id="module5">
        ...
        <div class="swiper-container sameSwiper samebox swiper-no-swiping">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_safe_p1.jpg" class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_safe_p1_m.jpg" class="pic pc_hide"/>
            </div>
            <!--<div class="swiper-slide scroll-slide">
              <img src="images/tiggo8ProMax/tiggo8promax_safe_p2.jpg"  class="pic m_hide"/>
              <img src="images/tiggo8ProMax/tiggo8promax_safe_p2_m.jpg"  class="pic pc_hide"/>
            </div>-->
          </div>
        </div>
        <div class="cutTab wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
          <div class="cutbtn on">Intelligent built-in dashcam</div>
          <!--<div class="cutbtn">9-Safety Airbags</div>-->
        </div>
      </div>
    </section>
