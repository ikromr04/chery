...
Route::get('/tiggo8promax', [PageController::class, 'tiggo8promax'])->name('tiggo8promax');
Route::get('/tiggo8promaxt', [PageController::class, 'tiggo8promaxt'])->name('tiggo8promaxt');
...
Route::get('/tiggo7promax', [PageController::class, 'tiggo7promax'])->name('tiggo7promax');
